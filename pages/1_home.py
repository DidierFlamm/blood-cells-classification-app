...
INTRO = """
The first version of this project, conducted between April and July 2023, by a team of four students from the Data Scientist Bootcamp at Mines Paris PSL & DataScientest.com, focuses on applying computer vision techniques to medical imaging.
...
The project began with an exploratory analysis of the datasets, including data cleaning, normalization, and augmentation to address class imbalance and improve generalization. We implemented a complete machine learning workflow, starting with traditional models (XGBoost, Random Forest, SVM) for baseline performance, followed by convolutional neural networks (CNNs) for advanced feature extraction and classification.
